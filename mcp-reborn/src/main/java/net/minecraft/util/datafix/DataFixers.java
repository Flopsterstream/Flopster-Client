...
public class DataFixers {
    ...
    private static void addFixers(DataFixerBuilder p_14514_) {
        ...
        p_14514_.addFixer(new TextComponentStrictJsonFix(schema14));
        ...
        Schema schema83 = p_14514_.addSchema(1925, V1925::new);
        ...
        Schema schema119 = p_14514_.addSchema(2538, SAME_NAMESPACED);
        p_14514_.addFixer(new LevelLegacyWorldGenSettingsFix(schema119));
        ...
        p_14514_.addFixer(new NamespacedTypeRenameFix(schema123, "Biomes fix", References.BIOME, createRenamer(BiomeFix.BIOMES)));
        ...
        p_14514_.addFixer(BlockRenameFix.create(schema128, "Renamed grass path block to dirt path", createRenamer("minecraft:grass_path", "minecraft:dirt_path")));
        ...
        p_14514_.addFixer(BlockRenameFix.create(schema132, "Renamed copper blocks to new oxidized terms", createRenamer(immutablemap)));
        ...
        p_14514_.addFixer(BlockRenameFix.create(schema133, "Rename copper blocks suffixes", createRenamer(immutablemap1)));
        ...
        p_14514_.addFixer(BlockRenameFix.create(schema135, "Renamed grimstone blocks to deepslate", createRenamer(immutablemap2)));
        ...
        Schema schema164 = p_14514_.addSchema(3090, SAME_NAMESPACED);
        p_14514_.addFixer(
            new EntityFieldsRenameFix(schema164, "EntityPaintingFieldsRenameFix", "minecraft:painting", Map.of("Motive", "variant", "Facing", "facing"))
        );
        Schema schema165 = p_14514_.addSchema(3093, SAME_NAMESPACED);
        p_14514_.addFixer(new EntityGoatMissingStateFix(schema165));
        Schema schema166 = p_14514_.addSchema(3094, SAME_NAMESPACED);
        p_14514_.addFixer(new GoatHornIdFix(schema166));
        Schema schema167 = p_14514_.addSchema(3097, SAME_NAMESPACED);
        p_14514_.addFixer(new FilteredBooksFix(schema167));
        p_14514_.addFixer(new FilteredSignsFix(schema167));
        Map<String, String> map = Map.of("minecraft:british", "minecraft:british_shorthair");
        p_14514_.addFixer(new VariantRenameFix(schema167, "Rename british shorthair", References.ENTITY, "minecraft:cat", map));
        p_14514_.addFixer(
            new CriteriaRenameFix(
                schema167,
        ...
        Schema schema168 = p_14514_.addSchema(3108, SAME_NAMESPACED);
        p_14514_.addFixer(new BlendingDataRemoveFromNetherEndFix(schema168));
        Schema schema169 = p_14514_.addSchema(3201, SAME_NAMESPACED);
        p_14514_.addFixer(new OptionsProgrammerArtFix(schema169));
        Schema schema170 = p_14514_.addSchema(3202, V3202::new);
        p_14514_.addFixer(new AddNewChoices(schema170, "Added Hanging Sign", References.BLOCK_ENTITY));
        Schema schema171 = p_14514_.addSchema(3203, V3203::new);
        p_14514_.addFixer(new AddNewChoices(schema171, "Added Camel", References.ENTITY));
        Schema schema172 = p_14514_.addSchema(3204, V3204::new);
        p_14514_.addFixer(new AddNewChoices(schema172, "Added Chiseled Bookshelf", References.BLOCK_ENTITY));
        Schema schema173 = p_14514_.addSchema(3209, SAME_NAMESPACED);
        p_14514_.addFixer(new ItemStackSpawnEggFix(schema173, false, "minecraft:pig_spawn_egg"));
        Schema schema174 = p_14514_.addSchema(3214, SAME_NAMESPACED);
        p_14514_.addFixer(new OptionsAmbientOcclusionFix(schema174));
        Schema schema175 = p_14514_.addSchema(3319, SAME_NAMESPACED);
        p_14514_.addFixer(new OptionsAccessibilityOnboardFix(schema175));
        Schema schema176 = p_14514_.addSchema(3322, SAME_NAMESPACED);
        p_14514_.addFixer(new EffectDurationFix(schema176));
        Schema schema177 = p_14514_.addSchema(3325, V3325::new);
        p_14514_.addFixer(new AddNewChoices(schema177, "Added displays", References.ENTITY));
        Schema schema178 = p_14514_.addSchema(3326, V3326::new);
        p_14514_.addFixer(new AddNewChoices(schema178, "Added Sniffer", References.ENTITY));
        Schema schema179 = p_14514_.addSchema(3327, V3327::new);
        p_14514_.addFixer(new AddNewChoices(schema179, "Archaeology", References.BLOCK_ENTITY));
        Schema schema180 = p_14514_.addSchema(3328, V3328::new);
        p_14514_.addFixer(new AddNewChoices(schema180, "Added interaction", References.ENTITY));
        Schema schema181 = p_14514_.addSchema(3438, V3438::new);
        p_14514_.addFixer(
        ...
        p_14514_.addFixer(new EntityBrushableBlockFieldsRenameFix(schema181));
        p_14514_.addFixer(
            ItemRenameFix.create(
                schema181,
        ...
        p_14514_.addFixer(new AddNewChoices(schema181, "Added calibrated sculk sensor", References.BLOCK_ENTITY));
        Schema schema182 = p_14514_.addSchema(3439, V3439::new);
        p_14514_.addFixer(new BlockEntitySignDoubleSidedEditableTextFix(schema182, "Updated sign text format for Signs", "minecraft:sign"));
        p_14514_.addFixer(new BlockEntitySignDoubleSidedEditableTextFix(schema182, "Updated sign text format for Hanging Signs", "minecraft:hanging_sign"));
        Schema schema183 = p_14514_.addSchema(3440, SAME_NAMESPACED);
        p_14514_.addFixer(
            new NamespacedTypeRenameFix(
        ...
        p_14514_.addFixer(new FeatureFlagRemoveFix(schema183, "Remove 1.20 feature toggle", Set.of("minecraft:update_1_20")));
        ...
        p_14514_.addFixer(new DropInvalidSignDataFix(schema189, "minecraft:sign"));
        p_14514_.addFixer(new DropInvalidSignDataFix(schema189, "minecraft:hanging_sign"));
        ...
        Schema schema208 = p_14514_.addSchema(3813, V3813::new);
        ...
        Schema schema237 = p_14514_.addSchema(4173, SAME_NAMESPACED);
        p_14514_.addFixer(new EntityFieldsRenameFix(schema237, "Rename TNT Minecart fuse", "minecraft:tnt_minecart", Map.of("TNTFuse", "fuse")));
        Schema schema238 = p_14514_.addSchema(4175, SAME_NAMESPACED);
        p_14514_.addFixer(new EquippableAssetRenameFix(schema238));
        p_14514_.addFixer(new CustomModelDataExpandFix(schema238));
        Schema schema239 = p_14514_.addSchema(4176, SAME_NAMESPACED);
        p_14514_.addFixer(new InvalidBlockEntityLockFix(schema239));
        p_14514_.addFixer(new InvalidLockComponentFix(schema239));
        Schema schema240 = p_14514_.addSchema(4180, SAME_NAMESPACED);
        p_14514_.addFixer(new FeatureFlagRemoveFix(schema240, "Remove Winter Drop toggle", Set.of("minecraft:winter_drop")));
        Schema schema241 = p_14514_.addSchema(4181, SAME_NAMESPACED);
        p_14514_.addFixer(new BlockEntityFurnaceBurnTimeFix(schema241, "minecraft:furnace"));
        p_14514_.addFixer(new BlockEntityFurnaceBurnTimeFix(schema241, "minecraft:smoker"));
        p_14514_.addFixer(new BlockEntityFurnaceBurnTimeFix(schema241, "minecraft:blast_furnace"));
        Schema schema242 = p_14514_.addSchema(4187, SAME_NAMESPACED);
        p_14514_.addFixer(
        ...
        Schema schema243 = p_14514_.addSchema(4290, V4290::new);
        p_14514_.addFixer(new UnflattenTextComponentFix(schema243));
        Schema schema244 = p_14514_.addSchema(4291, SAME_NAMESPACED);
        p_14514_.addFixer(new LegacyHoverEventFix(schema244));
        p_14514_.addFixer(new TextComponentStringifiedFlagsFix(schema244));
        Schema schema245 = p_14514_.addSchema(4292, V4292::new);
        p_14514_.addFixer(new TextComponentHoverAndClickEventFix(schema245));
        Schema schema246 = p_14514_.addSchema(4293, SAME_NAMESPACED);
        p_14514_.addFixer(new DropChancesFormatFix(schema246));
        Schema schema247 = p_14514_.addSchema(4294, SAME_NAMESPACED);
        p_14514_.addFixer(
        ...
        Schema schema248 = p_14514_.addSchema(4295, SAME_NAMESPACED);
        p_14514_.addFixer(new BlendingDataFix(schema248));
        Schema schema249 = p_14514_.addSchema(4296, SAME_NAMESPACED);
        p_14514_.addFixer(new AreaEffectCloudDurationScaleFix(schema249));
        Schema schema250 = p_14514_.addSchema(4297, SAME_NAMESPACED);
        p_14514_.addFixer(new ForcedChunkToTicketFix(schema250));
        Schema schema251 = p_14514_.addSchema(4299, SAME_NAMESPACED);
        p_14514_.addFixer(new EntitySpawnerItemVariantComponentFix(schema251));
        Schema schema252 = p_14514_.addSchema(4300, V4300::new);
        p_14514_.addFixer(new SaddleEquipmentSlotFix(schema252));
        Schema schema253 = p_14514_.addSchema(4301, V4301::new);
        p_14514_.addFixer(new EquipmentFormatFix(schema253));
        Schema schema254 = p_14514_.addSchema(4302, V4302::new);
        p_14514_.addFixer(new AddNewChoices(schema254, "Added Test and Test Instance Block Entities", References.BLOCK_ENTITY));
        Schema schema255 = p_14514_.addSchema(4303, SAME_NAMESPACED);
        p_14514_.addFixer(new EntityFallDistanceFloatToDoubleFix(schema255, References.ENTITY));
        p_14514_.addFixer(new EntityFallDistanceFloatToDoubleFix(schema255, References.PLAYER));
        Schema schema256 = p_14514_.addSchema(4305, SAME_NAMESPACED);
        p_14514_.addFixer(
        ...
        Schema schema257 = p_14514_.addSchema(4306, V4306::new);
        p_14514_.addFixer(new ThrownPotionSplitFix(schema257));
        Schema schema258 = p_14514_.addSchema(4307, V4307::new);
        p_14514_.addFixer(new TooltipDisplayComponentFix(schema258));
        Schema schema259 = p_14514_.addSchema(4309, SAME_NAMESPACED);
        p_14514_.addFixer(new RaidRenamesDataFix(schema259));
        p_14514_.addFixer(new ChunkTicketUnpackPosFix(schema259));
        Schema schema260 = p_14514_.addSchema(4311, SAME_NAMESPACED);
        p_14514_.addFixer(
            new AdvancementsRenameFix(
        ...
        Schema schema261 = p_14514_.addSchema(4312, V4312::new);
        p_14514_.addFixer(new PlayerEquipmentFix(schema261));
        Schema schema262 = p_14514_.addSchema(4314, SAME_NAMESPACED);
        p_14514_.addFixer(new InlineBlockPosFormatFix(schema262));
    }
