...
public class GuiGraphics {
    ...
    private void applyScissor(@Nullable ScreenRectangle p_281569_) {
        ...
        if (p_281569_ != null) {
            ...
            double d1 = p_281569_.left() * d0;
            double d2 = i - p_281569_.bottom() * d0;
            double d3 = p_281569_.width() * d0;
            double d4 = p_281569_.height() * d0;
    ...
    public void fill(RenderType p_286711_, int p_286234_, int p_286444_, int p_286244_, int p_286411_, int p_286671_, int p_286599_) {
        ...
        vertexconsumer.addVertex(matrix4f, p_286234_, p_286444_, p_286671_).setColor(p_286599_);
        vertexconsumer.addVertex(matrix4f, p_286234_, p_286411_, p_286671_).setColor(p_286599_);
        vertexconsumer.addVertex(matrix4f, p_286244_, p_286411_, p_286671_).setColor(p_286599_);
        vertexconsumer.addVertex(matrix4f, p_286244_, p_286444_, p_286671_).setColor(p_286599_);
    }
    ...
    private void fillGradient(VertexConsumer p_286862_, int p_283414_, int p_281397_, int p_283587_, int p_281521_, int p_283505_, int p_283131_, int p_282949_) {
        Matrix4f matrix4f = this.pose.last().pose();
        p_286862_.addVertex(matrix4f, p_283414_, p_281397_, p_283505_).setColor(p_283131_);
        p_286862_.addVertex(matrix4f, p_283414_, p_281521_, p_283505_).setColor(p_282949_);
        p_286862_.addVertex(matrix4f, p_283587_, p_281521_, p_283505_).setColor(p_282949_);
        p_286862_.addVertex(matrix4f, p_283587_, p_281397_, p_283505_).setColor(p_283131_);
    }
    ...
    public void fillRenderType(RenderType p_327925_, int p_328209_, int p_335424_, int p_329528_, int p_336385_, int p_332231_) {
        ...
        vertexconsumer.addVertex(matrix4f, p_328209_, p_335424_, p_332231_);
        vertexconsumer.addVertex(matrix4f, p_328209_, p_336385_, p_332231_);
        vertexconsumer.addVertex(matrix4f, p_329528_, p_336385_, p_332231_);
        vertexconsumer.addVertex(matrix4f, p_329528_, p_335424_, p_332231_);
    }
    ...
    public int drawString(Font p_282636_, FormattedCharSequence p_281596_, int p_281586_, int p_282816_, int p_281743_, boolean p_282394_) {
        return p_282636_.drawInBatch(
            p_281596_, p_281586_, p_282816_, p_281743_, p_282394_, this.pose.last().pose(), this.bufferSource, Font.DisplayMode.NORMAL, 0, 15728880
        );
    }
    ...
    private void innerBlit(
        ...
        vertexconsumer.addVertex(matrix4f, p_283092_, p_282113_, 0.0F).setUv(p_281327_, p_283166_).setColor(p_283583_);
        vertexconsumer.addVertex(matrix4f, p_283092_, p_281388_, 0.0F).setUv(p_281327_, p_282630_).setColor(p_283583_);
        vertexconsumer.addVertex(matrix4f, p_281930_, p_281388_, 0.0F).setUv(p_281676_, p_282630_).setColor(p_283583_);
        vertexconsumer.addVertex(matrix4f, p_281930_, p_282113_, 0.0F).setUv(p_281676_, p_283166_).setColor(p_283583_);
    }
    ...
    private void renderItem(
        ...
        if (!p_281675_.isEmpty()) {
            this.minecraft.getItemModelResolver().updateForTopItem(this.scratchItemStackRenderState, p_281675_, ItemDisplayContext.GUI, p_281754_, p_282619_, p_283260_);
            this.pose.pushPose();
            this.pose.translate(p_281271_ + 8, p_282210_ + 8, 150 + p_281995_);
