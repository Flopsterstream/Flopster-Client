...
public class RenderPipelines {
    ...
    private static final RenderPipeline.Snippet MATRICES_SNIPPET = RenderPipeline.builder()
        .withUniform("ModelViewMat", UniformType.MATRIX4X4)
        .withUniform("ProjMat", UniformType.MATRIX4X4)
        .buildSnippet();
    private static final RenderPipeline.Snippet FOG_NO_COLOR_SNIPPET = RenderPipeline.builder()
        .withUniform("FogStart", UniformType.FLOAT)
        .withUniform("FogEnd", UniformType.FLOAT)
        .withUniform("FogShape", UniformType.INT)
        .buildSnippet();
    private static final RenderPipeline.Snippet FOG_SNIPPET = RenderPipeline.builder(FOG_NO_COLOR_SNIPPET).withUniform("FogColor", UniformType.VEC4).buildSnippet();
    private static final RenderPipeline.Snippet MATRICES_COLOR_SNIPPET = RenderPipeline.builder(MATRICES_SNIPPET).withUniform("ColorModulator", UniformType.VEC4).buildSnippet();
    private static final RenderPipeline.Snippet MATRICES_COLOR_FOG_SNIPPET = RenderPipeline.builder(MATRICES_COLOR_SNIPPET, FOG_SNIPPET).buildSnippet();
    private static final RenderPipeline.Snippet MATRICES_COLOR_FOG_OFFSET_SNIPPET = RenderPipeline.builder(MATRICES_COLOR_FOG_SNIPPET).withUniform("ModelOffset", UniformType.VEC3).buildSnippet();
    private static final RenderPipeline.Snippet MATRICES_COLOR_FOG_LIGHT_DIR_SNIPPET = RenderPipeline.builder(MATRICES_COLOR_SNIPPET, FOG_SNIPPET)
