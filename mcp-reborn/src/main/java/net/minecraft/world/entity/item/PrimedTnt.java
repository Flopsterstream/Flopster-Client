...
public class PrimedTnt extends Entity implements TraceableEntity {
    ...
    protected void addAdditionalSaveData(CompoundTag p_32097_) {
        ...
        p_32097_.store("block_state", BlockState.CODEC, registryops, this.getBlockState());
    ...
    protected void readAdditionalSaveData(CompoundTag p_32091_) {
        RegistryOps<Tag> registryops = this.registryAccess().createSerializationContext(NbtOps.INSTANCE);
        this.setFuse(p_32091_.getShortOr("fuse", (short)80));
        this.setBlockState(p_32091_.read("block_state", BlockState.CODEC, registryops).orElse(DEFAULT_BLOCK_STATE));
        this.explosionPower = Mth.clamp(p_32091_.getFloatOr("explosion_power", 4.0F), 0.0F, 128.0F);
    }
