...
public class FireworkRocketEntity extends Projectile implements ItemSupplier {
    ...
    public void addAdditionalSaveData(CompoundTag p_37075_) {
        ...
        p_37075_.store("FireworksItem", ItemStack.CODEC, registryops, this.getItem());
    ...
    public void readAdditionalSaveData(CompoundTag p_37073_) {
        ...
        RegistryOps<Tag> registryops = this.registryAccess().createSerializationContext(NbtOps.INSTANCE);
        this.entityData.set(DATA_ID_FIREWORKS_ITEM, p_37073_.read("FireworksItem", ItemStack.CODEC, registryops).orElse(getDefaultItem()));
