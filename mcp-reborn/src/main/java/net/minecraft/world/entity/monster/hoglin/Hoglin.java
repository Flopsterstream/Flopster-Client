...
public class Hoglin extends Animal implements Enemy, HoglinBase {
    ...
    public void addAdditionalSaveData(CompoundTag p_34529_) {
        ...
        p_34529_.putBoolean("IsImmuneToZombification", this.isImmuneToZombification());
        p_34529_.putInt("TimeInOverworld", this.timeInOverworld);
        p_34529_.putBoolean("CannotBeHunted", this.cannotBeHunted);
    }

    @Override
    public void readAdditionalSaveData(CompoundTag p_34519_) {
        super.readAdditionalSaveData(p_34519_);
        this.setImmuneToZombification(p_34519_.getBooleanOr("IsImmuneToZombification", false));
        this.timeInOverworld = p_34519_.getIntOr("TimeInOverworld", 0);
        this.setCannotBeHunted(p_34519_.getBooleanOr("CannotBeHunted", false));
    }
