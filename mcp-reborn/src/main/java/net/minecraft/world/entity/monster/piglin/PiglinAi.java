...
public class PiglinAi {
    ...
    protected static void wasHurtBy(ServerLevel p_361749_, Piglin p_34838_, LivingEntity p_34839_) {
        if (!(p_34839_ instanceof Piglin)) {
            ...
            getAvoidTarget(p_34838_).ifPresent(p_390701_ -> {
                if (p_390701_.getType() != p_34839_.getType()) {
    ...
    protected static void broadcastAngerTarget(ServerLevel p_368320_, AbstractPiglin p_366359_, LivingEntity p_364430_) {
        getAdultPiglins(p_366359_).forEach(p_390704_ -> {
            if (p_364430_.getType() != EntityType.HOGLIN || p_390704_.canHunt() && ((Hoglin)p_364430_).canBeHunted()) {
                setAngerTargetIfCloserThanCurrent(p_368320_, p_390704_, p_364430_);
            }
        });
    }
