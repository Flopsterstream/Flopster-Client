...
public class GlStateManager {
    ...
    public static void _glUniform1(int p_396368_, IntBuffer p_396504_) {
        RenderSystem.assertOnRenderThread();
        GL20.glUniform1iv(p_396368_, p_396504_);
    }
    ...
    public static void _glUniform1(int p_395660_, FloatBuffer p_394551_) {
        RenderSystem.assertOnRenderThread();
        GL20.glUniform1fv(p_395660_, p_394551_);
    }

    public static void _glUniform2(int p_395185_, FloatBuffer p_397143_) {
        RenderSystem.assertOnRenderThread();
        GL20.glUniform2fv(p_395185_, p_397143_);
    }

    public static void _glUniform3(int p_396411_, IntBuffer p_396786_) {
        RenderSystem.assertOnRenderThread();
        GL20.glUniform3iv(p_396411_, p_396786_);
    }

    public static void _glUniform3(int p_397507_, FloatBuffer p_392712_) {
        RenderSystem.assertOnRenderThread();
        GL20.glUniform3fv(p_397507_, p_392712_);
    }

    public static void _glUniform4(int p_393800_, FloatBuffer p_397650_) {
        RenderSystem.assertOnRenderThread();
        GL20.glUniform4fv(p_393800_, p_397650_);
    }

    public static void _glUniformMatrix4(int p_397654_, FloatBuffer p_397564_) {
        RenderSystem.assertOnRenderThread();
        GL20.glUniformMatrix4fv(p_397654_, false, p_397564_);
    }
    ...
    public static void _glDeleteBuffers(int p_392748_) {
        RenderSystem.assertOnRenderThread();
        if (ON_LINUX) {
            GL32C.glBindBuffer(34962, p_392748_);
    ...
    public static void glActiveTexture(int p_392419_) {
        RenderSystem.assertOnRenderThread();
        GL13.glActiveTexture(p_392419_);
    }
    ...
    public static void _texImage2D(
        int p_391628_, int p_392395_, int p_394214_, int p_396350_, int p_394928_, int p_396300_, int p_397202_, int p_397817_, @Nullable IntBuffer p_394174_
    ) {
        RenderSystem.assertOnRenderThread();
        GL11.glTexImage2D(p_391628_, p_392395_, p_394214_, p_396350_, p_394928_, p_396300_, p_397202_, p_397817_, p_394174_);
    }
    ...
    public static void _texSubImage2D(
        int p_394769_, int p_392303_, int p_393147_, int p_394524_, int p_396987_, int p_394589_, int p_397928_, int p_397699_, IntBuffer p_395076_
    ) {
        RenderSystem.assertOnRenderThread();
        GL11.glTexSubImage2D(p_394769_, p_392303_, p_393147_, p_394524_, p_396987_, p_394589_, p_397928_, p_397699_, p_395076_);
    }
